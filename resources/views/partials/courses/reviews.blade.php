<div class="align-content-center">
  <div class="col-12 pt-0 mt-4">
    <h2 class="text-mutted">{{ __('Valoraciones ') }}</h2> <hr>
  </div>
    ...
    <div class="row">
      @forelse ($course->reviews as $review)
        <div class="col-md-8 offset-2 listing-block">
          <div class="media">
            <img src="{{ $review->user->pathAttachment() }}" alt="{{ $review->user->name }}" class="img-rounded">
      ...
      @empty
        <div class="alert alert-dark"><i class="fa fa-info-circle"></i> 
